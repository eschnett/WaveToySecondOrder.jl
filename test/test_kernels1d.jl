# Tests for `src/kernels1d.jl`: per-element `apply_laplacian!`, global
# `rhs!`, the diagnostic `build_global_laplacian`, and a full 1D wave
# evolution against the analytic solution.
